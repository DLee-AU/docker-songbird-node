...
python-coston-test: python-setup ##@Python	Run Python Tests Against Coston Node
	$(PYTHON) tests/app.py

# Testing
.PHONY: python-songbird-test
python-songbird-test: python-setup ##@Python	Run Python Tests Against Coston Node
	$(PYTHON) tests/app.py

.PHONY: python-setup
python-setup: ##@Python	Setup Python DockerImage ${PYTHON_IMAGE}
	$(QUIET) \
